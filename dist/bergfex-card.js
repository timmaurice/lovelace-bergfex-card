        ...
        <div class="card-content">
          ${t.map(([t,e])=>{const s=e.status;if(!s)return B`
              ...
              <div class="resort" tabindex="0" @click=${()=>this._handleMoreInfo(s)}>
                ...
                <div class="details">
                  ${this._config.show_snow?B`
                        ...
                        >
                          ...
                          <div class="detail-item-value">
                            ${d&&!isNaN(parseFloat(d.state))?B`<span>${d.state} ${d.attributes.unit_of_measurement??""}</span>`:B`<span class="n-a">N/A</span>`}
                            <span class="detail-item-label"
                  ...
                  ${this._config.show_lifts_slopes?B`
                        ...
                        >
                          ...
                          <div class="detail-item-value">
                            ${h&&p&&!isNaN(parseFloat(h.state))&&!isNaN(parseFloat(p.state))?B`<span>${h.state}/${p.state}</span> ${this._renderProgressBar(parseFloat(h.state),parseFloat(p.state))}`:B`<span class="n-a">N/A</span>`}
                            <span class="detail-item-label"
                              ...
                              >
                                ...
                                <div class="detail-item-value">
                                  ${v&&$&&!isNaN(parseFloat(v.state))&&!isNaN(parseFloat($.state))?B`<span
                                        ...
                                        >
                                        ${this._renderProgressBar(parseFloat(v.state),parseFloat($.state))}`:B`<span class="n-a">N/A</span>`}
                                  <span class="detail-item-label"
                              ...
                              >
                                ...
                                <div class="detail-item-value">
                                  ${y&&b&&!isNaN(parseFloat(y.state))&&!isNaN(parseFloat(b.state))?B`<span>${y.state}/${b.state}</span>
                                        ${this._renderProgressBar(parseFloat(y.state),parseFloat(b.state))}`:B`<span class="n-a">N/A</span>`}
                                  <span class="detail-item-label"
                ...
                ${this._config.show_conditions&&(_||f||g||m)?B`
                              ...
                              <div class="accordion-content details">
                                ${this._config.show_conditions&&(_||f)?B`
                                      ${_?B`
                                            ...
                                            >
                                              ...
                                              <div class="detail-item-value">
                                                <span
                                                  class=${vt({"n-a":this._isNA(_.state)})}
                                                  >${_.state}</span
                                                >
                                                <span class="detail-item-label"
                                      ...
                                      ${f?B`
                                            ...
                                            >
                                              ...
                                              <div class="detail-item-value">
                                                <span
                                                  class=${vt({"n-a":this._isNA(f.state)})}
                                                  >${f.state}</span
                                                >
                                                <span class="detail-item-label"
                                ...
                                ${this._config.show_conditions&&g?B`
                                      ...
                                      >
                                        ...
                                        <div class="detail-item-value">
                                          <span
                                            class=${vt({"n-a":this._isNA(g.state)})}
                                            >${g.state}</span
                                          >
                                          <span class="detail-item-label"
                                ...
                                ${m?B`
                                      ...
                                      >
                                        ...
                                        <div class="detail-item-value">
                                          <span
                                            class=${vt({"n-a":this._isNA(m.state)})}
                                            >${m.state}</span
                                          >
                                          <span class="detail-item-label"
