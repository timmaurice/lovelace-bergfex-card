        ...
        <div class="card-content">
          ${t.map(([t,e])=>{const s=e.status;if(!s)return B`
              ...
              <div class="resort" tabindex="0" @click=${()=>this._handleMoreInfo(s)}>
                ...
                <div class="details">
                  ${this._config.show_snow?B`
                        ...
                        >
                          ...
                          <div class="detail-item-value">
                            ${c&&!isNaN(parseFloat(c.state))?B`<span
                                  >${c.state} ${c.attributes.unit_of_measurement??""}</span
                                >`:B`<span>N/A</span>`}
                            <span class="detail-item-label"
                        ...
                        >
                          ...
                          <div class="detail-item-value">
                            ${d&&!isNaN(parseFloat(d.state))?B`<span>${d.state} ${d.attributes.unit_of_measurement??""}</span>`:B`<span>N/A</span>`}
                            <span class="detail-item-label"
                  ...
                  ${this._config.show_lifts_slopes?B`
                        ...
                        >
                          ...
                          <div class="detail-item-value">
                            ${h&&p&&!isNaN(parseFloat(h.state))&&!isNaN(parseFloat(p.state))?B`<span>${h.state}/${p.state}</span> ${this._renderProgressBar(parseFloat(h.state),parseFloat(p.state))}`:B`<span>N/A</span>`}
                            <span class="detail-item-label"
                      ...
                      `:""}
                  ${this._config.show_lifts_slopes&&(v||$||y||b)?B`
                        ${v&&$?B`
                              <div
                                class="detail-item"
                              ...
                              >
                                ...
                                <div class="detail-item-value">
                                  ${v&&$&&!isNaN(parseFloat(v.state))&&!isNaN(parseFloat($.state))?B`<span
                                        ...
                                        >
                                        ${this._renderProgressBar(parseFloat(v.state),parseFloat($.state))}`:B`<span>N/A</span>`}
                                  <span class="detail-item-label"
                        ...
                        ${y&&b?B`
                              ...
                              >
                                ...
                                <div class="detail-item-value">
                                  ${y&&b&&!isNaN(parseFloat(y.state))&&!isNaN(parseFloat(b.state))?B`<span>${y.state}/${b.state}</span>
                                        ${this._renderProgressBar(parseFloat(y.state),parseFloat(b.state))}`:B`<span>N/A</span>`}
                                  <span class="detail-item-label"
                ...
                ${this._config.show_conditions&&(_||f||g)||this._config.show_last_snowfall&&m?B`
                              ...
                              <div class="accordion-content details">
                                ${this._config.show_conditions&&(_||f)?B`
                                      ...
                                      ${f?B`
                                          ...
                                          `:""}
                                    `:""}
                                ${this._config.show_conditions&&g?B`
                                      <div
                                        class="detail-item"
                    ...
                    `:""}
                ${(()=>{if(!this._config.show_forecast)return"";const s=e.forecast_days&&e.forecast_days.length>0&&e.forecast_days.some(t=>{const e=this.hass.states[t];return e&&e.attributes.entity_picture}),o=e.forecast_summaries&&e.forecast_summaries.length>0&&e.forecast_summaries.some(t=>{const e=this.hass.states[t];return e&&e.attributes.entity_picture});return s||o?B`
                    <div class="accordion-container">
                      <div
                        class="accordion-header"
                      ...
                      ${"forecast"===this._accordionState[t]?B`
                            <div class="forecast-container">
                              ...
                              <div class="forecast-carousel">
                                ${(()=>{const s=this._forecastState[t]?.tab||"daily",o="daily"===s?e.forecast_days:e.forecast_summaries,i=this._forecastState[t]?.index||0;if(!o||0===o.length)return B``;const n=o[i],a=this.hass.states[n],r=a?.attributes.entity_picture;let c="";if("daily"===s){const t=n.match(/day_(\d+)/),e=t?parseInt(t[1],10):i;c=this._formatForecastDate(e)}else{const t=n.match(/summary_(\d+)h/),e=t?t[1]:"";c=At(this.hass,"component.bergfex-card.card.forecast.hour",{hours:e})}return B`
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function(t){return(e,s,o)=>((t,e,s)=>(s.configurable=!0,s.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,s),s))(e,s,{get(){return(e=>e.renderRoot?.querySelector(t)??null)(this)}})}("ha-card")],Pt.prototype,"_card",void 0),t([ut()],Pt.prototype,"_config",void 0),t([ut()],Pt.prototype,"_forecastState",void 0),t([ut()],Pt.prototype,"_accordionState",void 0),Pt=t([lt(Ct)],Pt),"undefined"!=typeof window&&(window.customCards=window.customCards||[],window.customCards.push({type:Ct,name:"Bergfex Card",description:"A Lovelace card to display ski resort conditions from Bergfex.",documentationURL:"https://github.com/timmaurice/lovelace-bergfex-card"}));const Mt=r`.card-config{display:flex;flex-direction:column;gap:12px}.group{border:1px solid var(--divider-color);border-radius:var(--ha-card-border-radius, 12px);margin-top:0;padding:16px}.group-header{color:var(--primary-text-color);font-size:16px;font-weight:500;margin-bottom:12px}ha-form{display:block}`,Ot=[{name:"title",selector:{text:{}}}],Tt=[{name:"resorts",selector:{device:{multiple:!0,integration:"bergfex"}}}];let Ut=class extends rt{setConfig(t){this._config={show_snow:!0,show_lifts_slopes:!0,show_conditions:!0,show_last_snowfall:!0,show_forecast:!1,...t}}_valueChanged(t){this.hass&&this._config&&St(this,"config-changed",{config:{...this._config,...t.detail.value}})}render(){if(!this.hass||!this._config)return B``;const t=[{name:"show_snow",selector:{boolean:{}}},{name:"show_lifts_slopes",selector:{boolean:{}}},{name:"show_conditions",selector:{boolean:{}}},{name:"show_last_snowfall",selector:{boolean:{}}},{name:"show_forecast",selector:{boolean:{}}},{name:"show_last_updated",selector:{boolean:{}}},{name:"show_link",selector:{boolean:{}}},{name:"hide_closed_resorts",selector:{boolean:{}}},{name:"sort_by",selector:{select:{mode:"dropdown",clearable:!0,options:[{value:"mountain",label:At(this.hass,"component.bergfex-card.editor.sort_by_options.mountain")},{value:"valley",label:At(this.hass,"component.bergfex-card.editor.sort_by_options.valley")},{value:"new",label:At(this.hass,"component.bergfex-card.editor.sort_by_options.new")},{value:"lift",label:At(this.hass,"component.bergfex-card.editor.sort_by_options.lift")},{value:"update",label:At(this.hass,"component.bergfex-card.editor.sort_by_options.update")}]}}}];return B`
      <ha-card>
    ...
    `}static{this.styles=r`
    ${a(Mt)}
  `}};t([pt({attribute:!1})],Ut.prototype,"hass",void 0),t([ut()],Ut.prototype,"_config",void 0),Ut=t([lt("bergfex-card-editor")],Ut);var Lt=Object.freeze({__proto__:null,get BergfexCardEditor(){return Ut}});export{Pt as BergfexCard};
