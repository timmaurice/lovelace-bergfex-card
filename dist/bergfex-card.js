 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const A=globalThis,S=A.trustedTypes,k=S?S.createPolicy("lit-html",{createHTML:t=>t}):void 0,E="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,N="?"+C,P=`<${N}>`,M=document,T=()=>M.createComment(""),O=t=>null===t||"object"!=typeof t&&"function"!=typeof t,U=Array.isArray,j="[ \t\n\f\r]",H=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,L=/-->/g,R=/>/g,z=RegExp(`>|${j}(?:([^\\s"'>=/]+)(${j}*=${j}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),D=/'/g,I=/"/g,F=/^(?:script|style|textarea|title)$/i,B=(t=>(e,...s)=>({_$litType$:t,strings:e,values:s}))(1),W=Symbol.for("lit-noChange"),V=Symbol.for("lit-nothing"),q=new WeakMap,G=M.createTreeWalker(M,129);function Z(t,e){if(!U(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==k?k.createHTML(e):e}const Y=(t,e)=>{const s=t.length-1,o=[];let i,n=2===e?"<svg>":3===e?"<math>":"",a=H;for(let e=0;e<s;e++){const s=t[e];let r,c,l=-1,d=0;for(;d<s.length&&(a.lastIndex=d,c=a.exec(s),null!==c);)d=a.lastIndex,a===H?"!--"===c[1]?a=L:void 0!==c[1]?a=R:void 0!==c[2]?(F.test(c[2])&&(i=RegExp("</"+c[2],"g")),a=z):void 0!==c[3]&&(a=z):a===z?">"===c[0]?(a=i??H,l=-1):void 0===c[1]?l=-2:(l=a.lastIndex-c[2].length,r=c[1],a=void 0===c[3]?z:'"'===c[3]?I:D):a===I||a===D?a=z:a===L||a===R?a=H:(a=z,i=void 0);const h=a===z&&t[e+1].startsWith("/>")?" ":"";n+=a===H?s+P:l>=0?(o.push(r),s.slice(0,l)+E+s.slice(l)+C+h):s+C+(-2===l?e:h)}return[Z(t,n+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),o]};class J{constructor({strings:t,_$litType$:e},s){let o;this.parts=[];let i=0,n=0;const a=t.length-1,r=this.parts,[c,l]=Y(t,e);if(this.el=J.createElement(c,s),G.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(o=G.nextNode())&&r.length<a;){if(1===o.nodeType){if(o.hasAttributes())for(const t of o.getAttributeNames())if(t.endsWith(E)){const e=l[n++],s=o.getAttribute(t).split(C),a=/([.?@])?(.*)/.exec(e);r.push({type:1,index:i,name:a[2],strings:s,ctor:"."===a[1]?et:"?"===a[1]?st:"@"===a[1]?ot:tt}),o.removeAttribute(t)}else t.startsWith(C)&&(r.push({type:6,index:i}),o.removeAttribute(t));if(F.test(o.tagName)){const t=o.textContent.split(C),e=t.length-1;if(e>0){o.textContent=S?S.emptyScript:"";for(let s=0;s<e;s++)o.append(t[s],T()),G.nextNode(),r.push({type:2,index:++i});o.append(t[e],T())}}}else if(8===o.nodeType)if(o.data===N)r.push({type:2,index:i});else{let t=-1;for(;-1!==(t=o.data.indexOf(C,t+1));)r.push({type:7,index:i}),t+=C.length-1}i++}}static createElement(t,e){const s=M.createElement("template");return s.innerHTML=t,s}}function K(t,e,s=t,o){if(e===W)return e;let i=void 0!==o?s._$Co?.[o]:s._$Cl;const n=O(e)?void 0:e._$litDirective$;return i?.constructor!==n&&(i?._$AO?.(!1),void 0===n?i=void 0:(i=new n(t),i._$AT(t,s,o)),void 0!==o?(s._$Co??=[])[o]=i:s._$Cl=i),void 0!==i&&(e=K(t,i._$AS(t,e.values),i,o)),e}class X{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,o=(t?.creationScope??M).importNode(e,!0);G.currentNode=o;let i=G.nextNode(),n=0,a=0,r=s[0];for(;void 0!==r;){if(n===r.index){let e;2===r.type?e=new Q(i,i.nextSibling,this,t):1===r.type?e=new r.ctor(i,r.name,r.strings,this,t):6===r.type&&(e=new it(i,this,t)),this._$AV.push(e),r=s[++a]}n!==r?.index&&(i=G.nextNode(),n++)}return G.currentNode=M,o}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class Q{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,o){this.type=2,this._$AH=V,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=K(this,t,e),O(t)?t===V||null==t||""===t?(this._$AH!==V&&this._$AR(),this._$AH=V):t!==this._$AH&&t!==W&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>U(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==V&&O(this._$AH)?this._$AA.nextSibling.data=t:this.T(M.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,o="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=J.createElement(Z(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===o)this._$AH.p(e);else{const t=new X(o,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=q.get(t.strings);return void 0===e&&q.set(t.strings,e=new J(t)),e}k(t){U(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,o=0;for(const i of t)o===e.length?e.push(s=new Q(this.O(T()),this.O(T()),this,this.options)):s=e[o],s._$AI(i),o++;o<e.length&&(this._$AR(s&&s._$AB.nextSibling,o),e.length=o)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class tt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,o,i){this.type=1,this._$AH=V,this._$AN=void 0,this.element=t,this.name=e,this._$AM=o,this.options=i,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=V}_$AI(t,e=this,s,o){const i=this.strings;let n=!1;if(void 0===i)t=K(this,t,e,0),n=!O(t)||t!==this._$AH&&t!==W,n&&(this._$AH=t);else{const o=t;let a,r;for(t=i[0],a=0;a<i.length-1;a++)r=K(this,o[s+a],e,a),r===W&&(r=this._$AH[a]),n||=!O(r)||r!==this._$AH[a],r===V?t=V:t!==V&&(t+=(r??"")+i[a+1]),this._$AH[a]=r}n&&!o&&this.j(t)}j(t){t===V?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class et extends tt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===V?void 0:t}}class st extends tt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==V)}}class ot extends tt{constructor(t,e,s,o,i){super(t,e,s,o,i),this.type=5}_$AI(t,e=this){if((t=K(this,t,e,0)??V)===W)return;const s=this._$AH,o=t===V&&s!==V||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,i=t!==V&&(s===V||o);o&&this.element.removeEventListener(this.name,this,s),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class it{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){K(this,t)}}const nt=A.litHtmlPolyfillSupport;nt?.(J,Q),(A.litHtmlVersions??=[]).push("3.3.1");const at=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
        ...
        <div class="card-content">
          ${t.map(([t,e])=>{const s=e.status;if(!s)return B`
              ...
              <div class="resort" tabindex="0" @click=${()=>this._handleMoreInfo(s)}>
                ...
                <div class="details">
                  ${this._config.show_snow?B`
                        ...
                        >
                          ...
                          <div class="detail-item-value">
                            ${c&&!isNaN(parseFloat(c.state))?B`<div class="value-row">
                  ...
                  ${this._config.show_lifts_slopes?B`
                        ...
                        >
                          ...
                          <div class="detail-item-value">
                            ${h&&p&&!isNaN(parseFloat(h.state))&&!isNaN(parseFloat(p.state))?B`<div class="value-row">
                                    <span>${h.state}/${p.state}</span>
                                    ${this._renderTrend(h.entity_id,h.state)}
                                  </div>
                                  ${this._renderProgressBar(parseFloat(h.state),parseFloat(p.state))}`:B`<span class="n-a">N/A</span>`}
                            <span class="detail-item-label"
                  ...
                  ${this._config.show_lifts_slopes&&(v||y||$||b)?B`
                        ${v&&y?B`
                              ...
                              >
                                ...
                                <div class="detail-item-value">
                                  ${v&&y&&!isNaN(parseFloat(v.state))&&!isNaN(parseFloat(y.state))?B`<div class="value-row">
                                          <span
                                            >${v.state}/${y.state}
                                        ...
                                        ${this._renderProgressBar(parseFloat(v.state),parseFloat(y.state))}`:B`<span class="n-a">N/A</span>`}
                                  <span class="detail-item-label"
                        ...
                        ${$&&b?B`
                              ...
                              >
                                ...
                                <div class="detail-item-value">
                                  ${$&&b&&!isNaN(parseFloat($.state))&&!isNaN(parseFloat(b.state))?B`<div class="value-row">
                                          <span>${$.state}/${b.state}</span>
                                          ${this._renderTrend($.entity_id,$.state)}
                                        </div>
                                        ${this._renderProgressBar(parseFloat($.state),parseFloat(b.state))}`:B`<span class="n-a">N/A</span>`}
                                  <span class="detail-item-label"
                ...
                ${this._config.show_conditions&&(_||f||m||g)?B`
                              ...
                              <div class="accordion-content details">
                                ${this._config.show_conditions&&(_||f)?B`
                                      ...
                                      ${f?B`
                                          ...
                                          `:""}
                                    `:""}
                                ${this._config.show_conditions&&m?B`
                                      <div
                                        class="detail-item"
...
function(t){return(e,s,o)=>((t,e,s)=>(s.configurable=!0,s.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,s),s))(e,s,{get(){return(e=>e.renderRoot?.querySelector(t)??null)(this)}})}("ha-card")],Pt.prototype,"_card",void 0),t([ut()],Pt.prototype,"_config",void 0),t([ut()],Pt.prototype,"_forecastState",void 0),t([ut()],Pt.prototype,"_accordionState",void 0),t([ut()],Pt.prototype,"_historyState",void 0),Pt=t([lt(Ct)],Pt),"undefined"!=typeof window&&(window.customCards=window.customCards||[],window.customCards.push({type:Ct,name:"Bergfex Card",description:"A Lovelace card to display ski resort conditions from Bergfex.",documentationURL:"https://github.com/timmaurice/lovelace-bergfex-card"}));const Mt=r`.card-config{display:flex;flex-direction:column;gap:12px}.group{border:1px solid var(--divider-color);border-radius:var(--ha-card-border-radius, 12px);margin-top:0;padding:16px}.group-header{color:var(--primary-text-color);font-size:16px;font-weight:500;margin-bottom:12px}ha-form{display:block}`,Tt=[{name:"title",selector:{text:{}}}],Ot=[{name:"resorts",selector:{device:{multiple:!0,integration:"bergfex"}}}];let Ut=class extends rt{setConfig(t){this._config={show_snow:!0,show_lifts_slopes:!0,show_conditions:!0,show_forecast:!1,show_trend:!1,...t}}_valueChanged(t){this.hass&&this._config&&St(this,"config-changed",{config:{...this._config,...t.detail.value}})}render(){if(!this.hass||!this._config)return B``;const t=[{name:"show_snow",selector:{boolean:{}}},{name:"show_lifts_slopes",selector:{boolean:{}}},{name:"show_conditions",selector:{boolean:{}}},{name:"show_forecast",selector:{boolean:{}}},{name:"show_trend",selector:{boolean:{}}},{name:"show_link",selector:{boolean:{}}},{name:"show_last_updated",selector:{boolean:{}}},{name:"hide_closed_resorts",selector:{boolean:{}}},{name:"sort_by",selector:{select:{mode:"dropdown",clearable:!0,options:[{value:"mountain",label:At(this.hass,"component.bergfex-card.editor.sort_by_options.mountain")},{value:"valley",label:At(this.hass,"component.bergfex-card.editor.sort_by_options.valley")},{value:"new",label:At(this.hass,"component.bergfex-card.editor.sort_by_options.new")},{value:"lift",label:At(this.hass,"component.bergfex-card.editor.sort_by_options.lift")},{value:"update",label:At(this.hass,"component.bergfex-card.editor.sort_by_options.update")}]}}}];return B`
    ...
    `}static{this.styles=r`
    ${a(Mt)}
  `}};t([pt({attribute:!1})],Ut.prototype,"hass",void 0),t([ut()],Ut.prototype,"_config",void 0),Ut=t([lt("bergfex-card-editor")],Ut);var jt=Object.freeze({__proto__:null,get BergfexCardEditor(){return Ut}});export{Pt as BergfexCard};
