                        ...
                        >
                          ...
                          <div class="detail-item-value">
                            ${h&&p&&!isNaN(parseFloat(h.state))&&!isNaN(parseFloat(p.state))?B`<div class="value-row">
                                  ...
                                  ${this._renderProgressBar(parseFloat(h.state),parseFloat(p.state))}`:B`<span>N/A</span>`}
                            <span class="detail-item-label"
                  ...
                  ${this._config.show_lifts_slopes&&(v||$||y||b)?B`
                        ${v?B`
                              ...
                              >
                                ...
                                <div class="detail-item-value">
                                  ${v&&!isNaN(parseFloat(v.state))?B`<div class="value-row">
                                          <span
                                            >${v.state}${$&&!isNaN(parseFloat($.state))?`/${$.state}`:""}
                                            ${v.attributes.unit_of_measurement??"km"}</span
                                          >
                                          ${this._renderTrend(v.entity_id,v.state)}
                                        </div>
                                        ${$&&!isNaN(parseFloat($.state))?this._renderProgressBar(parseFloat(v.state),parseFloat($.state)):""}`:B`<span>N/A</span>`}
                                  <span class="detail-item-label"
                        ...
                        ${y&&b?B`
                              <div
                                class=${vt({"detail-item":!0,"n-a":!y||!b||isNaN(parseFloat(y.state))||isNaN(parseFloat(b.state))})}
                                @click=${t=>{t.stopPropagation(),y&&this._handleMoreInfo(y.entity_id)}}
                              >
                                <ha-icon icon="mdi:counter"></ha-icon>
                                <div class="detail-item-value">
                                  ${y&&b&&!isNaN(parseFloat(y.state))&&!isNaN(parseFloat(b.state))?B`<div class="value-row">
                                          <span>${y.state}/${b.state}</span>
                                          ${this._renderTrend(y.entity_id,y.state)}
                                        </div>
